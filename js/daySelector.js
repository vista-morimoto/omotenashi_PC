$(function() {
	...
	$("div#SearchBox .searchCat").click(function() {
		...
		HtmlBody.animate({ scrollTop: $(eventcash).offset().top - 300 + 'px' }, 'slow','swing');		 
...
function getDateString(dateStr) {
	...
	var week = ["<span class='colSun'>（日）</span>","<span>（月）</span>","<span>（火）</span>","<span>（水）</span>","<span>（木）</span>","<span>（金）</span>","<span class='colSat'>（土）</span>"];
